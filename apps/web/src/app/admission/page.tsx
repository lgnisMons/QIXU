...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "免费AI志愿填报助手。输入分数位次，基于历年录取数据（模拟）提供冲刺/稳妥/保底三梯度推荐方案。含费用分析和职业建议。",
  },
  alternates: {
    canonical: "/admission",
  },
...
const faqJsonLd = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "当前使用模拟2023-2025年录取数据进行规则引擎分析。数据覆盖10个省份、40余所高校。推荐结果仅供参考，正式填报请以各省教育考试院官方数据为准。",
      },
    },
    {
      "@type": "Question",
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "建议采用「冲-稳-保」梯度策略：20%冲刺志愿 + 50%稳妥志愿 + 30%保底志愿。综合考虑分数位次、专业偏好、城市偏好、学费预算和职业规划等因素。QIXU的规则引擎从8个维度综合评分，帮你科学决策。",
      },
    },
  ],
};
