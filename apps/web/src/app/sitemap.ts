...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticRoutes = [
    ...
    { url: ROUTES.admission, changeFrequency: "daily" as const, priority: 0.95 },
    { url: ROUTES.ai, changeFrequency: "weekly" as const, priority: 0.9 },
    { url: ROUTES.gaokaoVolunteer, changeFrequency: "weekly" as const, priority: 0.9 },
    { url: ROUTES.assessment, changeFrequency: "weekly" as const, priority: 0.85 },
    { url: ROUTES.tutor, changeFrequency: "weekly" as const, priority: 0.8 },
    { url: ROUTES.shenzhenTutor, changeFrequency: "weekly" as const, priority: 0.8 },
    { url: ROUTES.aiStudyPlanner, changeFrequency: "weekly" as const, priority: 0.75 },
    { url: ROUTES.growth, changeFrequency: "weekly" as const, priority: 0.75 },
    { url: ROUTES.tools, changeFrequency: "weekly" as const, priority: 0.7 },
    { url: ROUTES.aiToolsCourse, changeFrequency: "weekly" as const, priority: 0.7 },
